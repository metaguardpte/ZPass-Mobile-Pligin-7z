...
uint64_t plzma_registrator_3(void) {
    return NArchive::NLzma::NLzmaAr::g_ArcInfo.Flags;
}

uint64_t plzma_registrator_4(void) {
    return NArchive::NLzma::NLzma86Ar::g_ArcInfo.Flags;
}
#endif
