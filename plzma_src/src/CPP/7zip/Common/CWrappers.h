...
struct CCompressProgressWrap final
{
...
struct CSeekInStreamWrap final
{
  ISeekInStream vt;
  IInStream *Stream;
  HRESULT Res;
...
struct CSeqOutStreamWrap final
{
  ISeqOutStream vt;
