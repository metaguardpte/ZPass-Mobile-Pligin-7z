...
class CSemaphore final  MY_UNCOPYABLE
{
  ::CSemaphore _object;
public:
...
class CCriticalSection final  MY_UNCOPYABLE
{
...
class CCriticalSectionLock final  MY_UNCOPYABLE
{
  CCriticalSection *_object;
...
class CSynchro final  MY_UNCOPYABLE
{
...
class CManualResetEvent_WFMO final : public CBaseEvent_WFMO
{
public:
...
class CAutoResetEvent_WFMO final : public CBaseEvent_WFMO
{
public:
...
class CSemaphore_WFMO final : public CBaseHandle_WFMO
{
  UInt32 _count;
  UInt32 _maxCount;
